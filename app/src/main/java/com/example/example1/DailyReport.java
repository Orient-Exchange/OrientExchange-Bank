...
public class DailyReport extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener {
    String email;
    TableLayout ll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Toast.makeText(this, email, Toast.LENGTH_SHORT).show();
        if(email == ""){
            ...
            getJSON("https://www.orientexchange.in/bankagent/daily-report-app.php",email,date1,date2);
            nDialog = new ProgressDialog(DailyReport.this);
        ...
        sharedPreferences1=DailyReport.this.getSharedPreferences(orderPREFERENCES, Context.MODE_PRIVATE);
        sharedPreferences2=DailyReport.this.getSharedPreferences(statusPREFERENCES, Context.MODE_PRIVATE);
        sharedPreferences3=DailyReport.this.getSharedPreferences(amountPREFERENCES, Context.MODE_PRIVATE);
                ...
                try {
                    if(s!=null && !s.isEmpty()) {
                        ...
                        /*  TableRow row= new TableRow(DailyReport.this);
                            ...
                            tv1 = new TextView(DailyReport.this);
                            ...
                            tv5 = new TextView(DailyReport.this);
                            ...
                            tv2 = new TextView(DailyReport.this);
                            ...
                            tv3 = new TextView(DailyReport.this);
                            ...
                            tv4 = new TextView(DailyReport.this);
                            ...
                            LinearLayout layout = new LinearLayout(DailyReport.this);
