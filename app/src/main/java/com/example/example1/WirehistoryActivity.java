...
public class WirehistoryActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    String email;
    TableLayout ll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wirehistory);
        ...
        else { getJSON("https://www.orientexchange.in/bankagent/daily-report-app-remittance.php",email,date1,date2);
            nDialog = new ProgressDialog(WirehistoryActivity.this);
            nDialog.setMessage("Loading..");
            nDialog.setTitle("");
            nDialog.setIndeterminate(false);
            nDialog.setCancelable(true);
            nDialog.show();}
        sharedPreferences1=WirehistoryActivity.this.getSharedPreferences(orderPREFERENCES, Context.MODE_PRIVATE);
        sharedPreferences2=WirehistoryActivity.this.getSharedPreferences(statusPREFERENCES, Context.MODE_PRIVATE);
        sharedPreferences3=WirehistoryActivity.this.getSharedPreferences(amountPREFERENCES, Context.MODE_PRIVATE);
                ...
                try {
                    if(s!=null && s!="") {
                        ...
                        /*  TableRow row= new TableRow(DailyReport.this);
                            ...
                            tv1 = new TextView(WirehistoryActivity.this);
                            ...
                            tv5 = new TextView(WirehistoryActivity.this);
                            ...
                            tv2 = new TextView(WirehistoryActivity.this);
                            ...
                            tv3 = new TextView(WirehistoryActivity.this);
                            ...
                            tv4 = new TextView(WirehistoryActivity.this);
                            ...
                            textview4Params.setMargins(10, 10, 10, 15);
                            ...
                            LinearLayout layout = new LinearLayout(WirehistoryActivity.this);
    ...
    public void fetch_data(View view){
        ...
        date2=ed2.getText().toString();
      //  Toast.makeText(this, date1+" , "+date2, Toast.LENGTH_SHORT).show();
        getJSON("https://www.orientexchange.in/bankagent/daily-report-app-remittance.php",email,date1,date2);
        nDialog = new ProgressDialog(WirehistoryActivity.this);
        nDialog.setMessage("Loading..");
        nDialog.setTitle("");
        nDialog.setIndeterminate(false);
