...
public class Sell_placeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sell_place);
        ...
        spinner1[0].setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position == 0){
                    ...
                    ArrayAdapter<String> dataAdapter_pro = new ArrayAdapter<String>(Sell_placeActivity.this, android.R.layout.simple_spinner_item, product);
    ...
    public void own_func(View view){
        Intent it=new Intent(getApplicationContext(),Ownsell_placeActivity.class);
        startActivity(it);
    }
        ...
        if(Count < 4 && !TextUtils.isEmpty(edt_val) && Integer.parseInt(edt_val) !=0){
            if(!curreny.equals("Currency")) {
                if(pros.equals("cash")) {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Sell_placeActivity.this, android.R.layout.simple_spinner_item, categories);
    ...
    private void getresult(final String urlWebService, final String user_email, final ArrayList<String> ccode, final ArrayList<String> ppro, final ArrayList<String> qnt, final ArrayList<String> inr, final ArrayList<String> crate, final String custname, final String custnum, final String TotalInr, final String dooraddress, final String cpincode, final String branch_name, final String Delivery) {
        ...
        class GetResult extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                if(!s.isEmpty()) {
                    Toast.makeText(Sell_placeActivity.this, s, Toast.LENGTH_SHORT).show();
                    Log.i("Response",s);
                   p1.setVisibility(View.INVISIBLE);
                    button.setBackground(ContextCompat.getDrawable(Sell_placeActivity.this, R.drawable.sellcashtext));
