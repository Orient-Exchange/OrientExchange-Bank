...
public class Ownsell_placeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ownsell_place);
        ...
        spinner1[0].setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position == 0){
                    ...
                    ArrayAdapter<String> dataAdapter_pro = new ArrayAdapter<String>(Ownsell_placeActivity.this, android.R.layout.simple_spinner_item, product);
    ...
    public void referal_func(View view){
        Intent it=new Intent(getApplicationContext(),Sell_placeActivity.class);
        startActivity(it);
    }
        ...
        if(Count <4 && !TextUtils.isEmpty(edt_val) && Integer.parseInt(edt_val) !=0){
            if(!curreny.equals("Currency")) {
                if(pros.equals("cash")) {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Ownsell_placeActivity.this, android.R.layout.simple_spinner_item, categories);
                ...
                if(s !="") {
                    ...
                    try {
                        ...
                        for (int j = 0; j < arr.length(); j++) {
                            ...
                            categories.add(Currency);
                            String sell_cash = NewData.getString("buycash");
    ...
    private void getresult(final String urlWebService, final String user_email, final ArrayList<String> ccode, final ArrayList<String> ppro, final ArrayList<String> qnt, final ArrayList<String> inr, final ArrayList<String> crate, final String TotalInr, final String Delivery,final String Notes) {
        ...
        class GetResult extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                if(!s.isEmpty()) {
                    Toast.makeText(Ownsell_placeActivity.this, s, Toast.LENGTH_SHORT).show();
                    Log.i("Response",s);
                    p1.setVisibility(View.INVISIBLE);
                    button.setBackground(ContextCompat.getDrawable(Ownsell_placeActivity.this, R.drawable.sellcashtext));
                    ...
                    if(s.equals("ok")){
                        ...
                        AlertDialog.Builder alert = new AlertDialog.Builder(Ownsell_placeActivity.this);
                        alert.setTitle("");
